...
cl = LINETCR.LINE()
cl.login(token="EnVukivXxNw9NtTenh7a.0ikaZF3A5tcECFODftsw2G.jsd2sqfM1NPnCmVkxFynjSxd1tqtuvl2O+crVRDsZaU=")
cl.loginResult()
     ...
     #-----Fungsi List Group------#   
      ...
      #-------------Fungsi Creator Start-----------------# 
		...
		for ticket_id in n_links:
            ...
            elif msg.text in ["Bi on","joinn on"]:
              if msg.from_ in admin:
                if wait["Protectjoin"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Bi off","joinn off"]:
              if msg.from_ in admin:
                if wait["Protectjoin"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Cn on","cancl on"]:
              if msg.from_ in admin:
                if wait["Protectcancl"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Cn off","cancl off"]:
              if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                if wait["Protectgr"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Qr off","gr off"]:
              if msg.from_ in admin:
